...
public class LoginInOutTest {
    ...
    public void loginInOutTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.phone),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("12345678"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.phone), withText("12345678"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("53002711"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.phone), withText("53002711"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
